...
data class RepoHealthDto(
    ...
    @SerialName("service_status") val serviceStatus: OpsStatusDto? = null,
...
data class OpsHostSnapshotDto(
    ...
    @SerialName("backend_service_status") val backendServiceStatus: OpsStatusDto? = null,
    @SerialName("server_py_runtime_label") val serverPyRuntimeLabel: String,
    @SerialName("server_py_service_status") val serverPyServiceStatus: OpsStatusDto? = null,
